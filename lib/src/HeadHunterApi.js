...
var HeadHunterApi = (function () {
    ...
    HeadHunterApi.prototype.getVacancy = function (keywords, area, experience) {
        ...
        var params = [textParam];
        if (area)
            params.push(new RequestParam_1.RequestParam('area', area));
        if (experience)
            params.push(new RequestParam_1.RequestParam('experience', experience));
        return this.getCustomVacancy.apply(this, params);
    };
    /**
